...
org.netbeans.lib.awtextra.AbsoluteLayout());
 ...
 l1.setFont(new java.awt.Font("Bookman Old Style", 1, 12)); 
// NOI18N
...
evt) {
 ...
 b1.setFont(new java.awt.Font("Bookman Old Style", 0, 12)); 
// NOI18N
 b1.setText("Encrypt");
...
evt) {
 ...
 jButton1.setFont(new java.awt.Font("Bookman Old Style", 0, 
12)); // NOI18N
...
evt) {
 ...
 jLabel1.setFont(new java.awt.Font("Bookman Old Style", 1, 
24)); // NOI18N
 jLabel1.setForeground(new java.awt.Color(255, 0, 0));
 
jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
 jLabel1.setText("Data Leakage Prevention System - Hybrid 
Cryptography");
 ta1.setColumns(20);
...
org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1090, 600));
 pack();
...
+"\n");
 ...
 output = output + "Stage 1 Encrytion : " 
+en;
 ...
 output = output + "Stage 1 Encryption : " 
+en;
 i=i+1;
 }
...
myEncryptor4.bytesToString(end);
 ta1.setText(output);
 ta2.setText("");
 }
 catch(Exception e)
...
{//GEN-FIRST:event_t1ActionPerformed
